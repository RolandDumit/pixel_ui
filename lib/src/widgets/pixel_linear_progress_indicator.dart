...
class PixelLinearProgressIndicator extends PixelStatelessWidget {
  ...
  const PixelLinearProgressIndicator({
    ...
    super.pixelBorderColor = PixelColors.borderColor,
    super.pixelBorderWidth = 1,
    super.pixelShadowColor = PixelColors.shadowColor,
    super.pixelShadowOffset = 2,
    this.progress = 0,
    this.totalPixels = 24,
    ...
    return Row(
      ...
      children: List.generate(
        ...
        (index) => Pixel(
          ...
          shadowColor: pixelShadowColor,
          shadowOffset: pixelShadowOffset,
        ),
      ),
    );
  }
